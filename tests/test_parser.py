...
def test_exclude(htmlparser, subtests):
  tests = (
    {'test': '<script>script</script', 'expected': '<data><head></head><body></body></data>'},
    {'test': '<noscript>noscript</noscript>', 'expected': '<data><head></head><body></body></data>'},
    {'test': '<style>noscript</style>', 'expected': '<data><head></head><body></body></data>'},
  )
  for test in tests:
